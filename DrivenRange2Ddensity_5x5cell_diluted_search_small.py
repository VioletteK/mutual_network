{
    ...
    'Recorders' : {
        'py' : {
            ...
            'v' : {
                'MUA': True,
                'x': 0, #Correspond à la limite inférieure gauche du carré de 10x10 centré en 32 donc 32-5=27
                'y': 0,
                'size': 28,
            },
            'gsyn_exc' : {
    ...
    'Injections' : {
        'py' : { # 'modKey':{modVal}
             ...
             #
             'cellidx' : [15*29+14,15*29+15,15*29+16,15*30+14,15*30+15,15*30+16,15*31+14,15*31+15,15*31+16]
